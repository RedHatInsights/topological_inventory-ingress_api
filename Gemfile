...
# TODO switch to upstream openapi_parser once all commits were merged and released
# gem 'openapi_parser',    '~> 0.2.5'
gem 'openapi_parser',    :git => 'https://github.com/Ladas/openapi_parser', :branch => 'master'
