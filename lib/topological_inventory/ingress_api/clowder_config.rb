...
ENV["QUEUE_HOST"] = TopologicalInventory::IngressApi::ClowderConfig.instance["kafkaHost"]
ENV["QUEUE_PORT"] = TopologicalInventory::IngressApi::ClowderConfig.instance["kafkaPort"].to_s

# ManageIQ Logger depends on these variables
ENV['CW_AWS_ACCESS_KEY_ID']     = TopologicalInventory::IngressApi::ClowderConfig.instance["awsAccessKeyId"]
ENV['CW_AWS_SECRET_ACCESS_KEY'] = TopologicalInventory::IngressApi::ClowderConfig.instance["awsSecretAccessKey"]
